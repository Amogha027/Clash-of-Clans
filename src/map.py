...
### begin ###
    for star in stealth_archers:
        ...
        b = 2*star.position[1]
        ctime = time.time()
        if (ctime - star.btime < 10):
            map_matrix[a+1][b] = starColor(star) + Fore.BLACK + 'in'
            map_matrix[a+1][b+1] = starColor(star) + Fore.BLACK + 'vi'
        else:
            map_matrix[a+1][b] = starColor(star) + Fore.BLACK + '  '
            map_matrix[a+1][b+1] = starColor(star) + Fore.BLACK + '  '
        map_matrix[a][b] = starColor(star) + Fore.BLACK + 'ST'
        map_matrix[a][b+1] = starColor(star) + Fore.BLACK + 'AR'

    for he in healers:
        a = 2*he.position[0]
        b = 2*he.position[1]
        map_matrix[a][b] = healerColor(he) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = healerColor(he) + Fore.BLACK + '  '
        map_matrix[a][b+1] = healerColor(he) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = healerColor(he) + Fore.BLACK + 'ER'
### end ###
