...
### begin ###
        ...
        self.walls_level = config['walls_level']
        self.cannon_levels = config['cannon_levels']
        self.wizard_tower_levels = config['wizard_tower_levels']
### end ###
    ...
    def generate_map(self):
        ...
        for idx, cannon in enumerate(self.cannons):                                     # cannon is 2x2
            cannon_obj = bd.Cannon(cannon, self, self.cannon_levels[idx])
            ...
            map[cannon[0]+1][cannon[1]+1] = pt.CANNON + \
                ":" + str(cannon[0]) + ":" + str(cannon[1])
        for idx, wizard_tower in enumerate(self.wizard_towers):                          # wizard tower is 1X1
            wizard_tower_obj = bd.WizardTower(wizard_tower, self, self.wizard_tower_levels[idx])
